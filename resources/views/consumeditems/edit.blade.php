            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('storeitems') }}">Store Items</a></li>
        ...
        <form action="{{ route('storeitems.update', $storeitem->itemId) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="categoryId" id="categoryId" class="form-control @error('categoryId') is-invalid @enderror">
                    ...
                    <option value="{{$category->categoryId}}" {{ $storeitem->categoryId == $category->categoryId ? 'selected' : '' }}>{{$category->catgeoryName}}</option>
                    @endforeach
                </select>
                @error('categoryId')
