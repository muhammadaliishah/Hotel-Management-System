...
@endif
    ...
    <div class="card-body">
        ...
        <form id="expense-entry" action="{{ route('employee_transactions.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

            <div class="form-group">
                <label for="emp_Id">Employee</label>
                <input type="hidden" name="payment_nature" value="{{$paymentNature}}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="transaction_amount" class="form-control @error('transaction_amount') is-invalid @enderror" id="transaction_amount"
                    placeholder="Employee Salary Amount" value="{{ old('transaction_amount') }}">
            ...
            <div class="form-group">
                ...
                <input type="date" name="transaction_date" class="form-control @error('transaction_date') is-invalid @enderror" id="transaction_date"
                    placeholder="Employee Salary Amount" value="{{ old('transaction_date',$defaultDate) }}">
            ...
            <button class="btn btn-lg btn-primary float-right text-white" type="submit">Create Loan</button>
        </form>
</div>
</div>
</div>
