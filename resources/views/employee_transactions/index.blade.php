                ...
                <tr>
                    ...
                    <td>
                    	<span class="right badge badge-danger">
                    		Rs. {{$empLoan->AmountReceived}}
                    	</span>
                    </td>
                    <td>
                    	<span class="right badge badge-success">
                    		Rs. {{$empLoan->AmountPaid}}
                		</span>
                	</td>
                    <td>Rs.{{$empLoan->AmountReceived+$empLoan->AmountPaid}}</td>
                    <td>
                    	<a href="{{ route('employee_transactions.create', 1) }}" class="btn btn-secondary"><i
                                class="fas fa-edit"></i>Add Loan Payments</a>
                        <a href="{{ route('employee_transactions.show', $empLoan->emp_Id   ) }}" class="btn btn-primary"><i
                                class="fas fa-edit"></i>View Details</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
