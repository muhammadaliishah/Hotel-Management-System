        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h1>Item Store Categories</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Admin</a></li>
                        <li class="breadcrumb-item active">Item Store Categories</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
@endif
    <div class="card">
        <div class="card-header bg-info">
            ...
            Item Store Category Management
            </h3>
    <div class="float-right">
            ...
            <a class="btn btn-danger"  href="{{ route('itemcategories.create')}}"><i class="fa fa-plus text-white"></i></a>
    </div>
            </div>
    <div class="card-body" style="overflow:auto;">
        ...
        <table class="table table-sm table-striped" >
            ...
            <tbody>
                ...
                <tr>
                    <td>{{++$i}}</td>
                    <td>{{$itemcategory->catgeoryName}}</td>
                    <td>{{$itemcategory->categoryDetail}}</td>
                    <td>{{$itemcategory->categoryAbb}}</td>
                    <td>{{$itemcategory->created_at}}</td>
                    <td>{{$itemcategory->updated_at}}</td>
                    <td>
                        <a href="{{ route('itemcategories.edit', $itemcategory->categoryId) }}" class="btn btn-primary"><i
                                class="fas fa-edit"></i></a>
                        <button class="btn btn-danger btn-delete" data-url="{{route('itemcategories.destroy', $itemcategory->categoryId)}}"><i
